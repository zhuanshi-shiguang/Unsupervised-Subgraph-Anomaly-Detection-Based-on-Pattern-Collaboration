...
if __name__ == '__main__':
    ...
    parser.add_argument('--real_world_name', type=str, default='Ethereum_TSGN')#Ethereum_TSGN simML AMLpublic Ethereum_TSGN Citeseer Cora
    parser.add_argument('--dataset', type=str, default='Ethereum_TSGN')
    parser.add_argument('--anomaly_type', type=str, default='Ethereum_TSGN')
    ...
    parser.add_argument('--warmup', type=int, default=84)
